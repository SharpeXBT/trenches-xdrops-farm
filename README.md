...
| Knob | Meaning |
|---|---|
| `SYMBOL` | spot pair, BASE-QUOTE, e.g. `SOL-USDC` (default set for the HYPE X Drops, 11-17 Sep 2026). Check which pair the campaign actually counts - on RE only the USDC pair earned, USDT volume counted for nothing |
